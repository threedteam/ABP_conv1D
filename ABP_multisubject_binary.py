...
def EEG_1d(num=1):
    ...
    callbacks_list = [
        keras.callbacks.ModelCheckpoint(
            filepath='D:\\modelSave\\55555_eleven_changeinput_test0.1_ABP_leaf_1dconv_ModelCheckpoint_' + str(num) + '.h5',
    ...
    path = 'D:\\modelSave\\55555_eleven_changeinput_test0.1_ABP_leaf_1dconv_' + str(num) + '.h5'
    model.save(path)
